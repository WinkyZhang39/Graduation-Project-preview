...
# sam_checkpoint = "../weights/irsam_model_converted.pt"
sam_checkpoint = "../weights/mobile_sam.pt"
# model_type = "vit_t"

# mobile_sam = sam_model_registry[model_type](checkpoint=sam_checkpoint)
mobile_sam = build_sam_vit_t(checkpoint=sam_checkpoint)
mobile_sam = mobile_sam.to(device=device)
mobile_sam.eval()

mask_generator = SamAutomaticMaskGenerator(mobile_sam)#用于自动生成所有物体的mask
predictor = SamPredictor(mobile_sam)#用于基于提示（如点）生成特定物体的mask
...
No points selected
45 32 True    add mask
142 96 False  remove area
[[197 140]
 [624 421]] True
[1 0] True    result
Traceback (most recent call last):
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\gradio\queueing.py", line 407, in call_prediction
    output = await route_utils.call_process_api(
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\gradio\route_utils.py", line 226, in call_process_api
    output = await app.get_blocks().process_api(
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\gradio\blocks.py", line 1550, in process_api
    result = await self.call_function(
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\gradio\blocks.py", line 1185, in call_function
    prediction = await anyio.to_thread.run_sync(
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\anyio\to_thread.py", line 56, in run_sync
    return await get_async_backend().run_sync_in_worker_thread(
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\anyio\_backends\_asyncio.py", line 2476, in run_sync_in_worker_thread
    return await future
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\anyio\_backends\_asyncio.py", line 967, in run
    result = context.run(func, *args)
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\gradio\utils.py", line 661, in wrapper
    response = f(*args, **kwargs)
  File "D:\毕设\IRSAM-mine\app\app.py", line 138, in segment_with_points
    results = format_results(masks, scores, logits, 0)
  File "D:\毕设\IRSAM-mine\app\utils\tools.py", line 49, in format_results
    np.min(tmp[0]),
  File "C:\Users\Winky Zhang\.conda\envs\PT\lib\site-packages\numpy\core\fromnumeric.py", line 2953, in min
